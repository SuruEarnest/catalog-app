...
import com.omnirio.catalog.app.exceptions.CustomResponse.CustomResponseBuilder;
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
	 ...
	 * // unauthorized-401
	 * 
	 * @ExceptionHandler(InvalidJwtAuthenticationException.class) public final
	 * ResponseEntity<CustomResponse<?>>
	 * invalidJwtAuthentication(InvalidJwtAuthenticationException ex, WebRequest
	 * request) { CustomResponse<?> response = new
	 ...
	 * .withStatus(HttpStatus.UNAUTHORIZED).build(); return new
	 * ResponseEntity<>(response, response.getStatus()); }
	 */
